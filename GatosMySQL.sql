...
INSERT INTO Protectora (Nombre_Protectora, Direccion, Email, Telefono, Pagina_Web, Imagen_Protectora)
VALUES 
...
CREATE TABLE Perro (
    ...
    Esterilizado BIT NOT NULL,
    Sexo VARCHAR(10) NOT NULL,
    Descripcion_Perro VARCHAR(1000) NOT NULL,
    Imagen_Perro VARCHAR(MAX) NOT NULL,
    FOREIGN KEY (Id_Protectora) REFERENCES Protectora(Id_Protectora)
);

INSERT INTO Perro (Id_Protectora, Nombre_Perro, Raza, Edad, Esterilizado, Sexo, Descripcion_Perro, Imagen_Perro)
VALUES 
(2, 'Pitufo', 'Chihuahua', 7, 0, 'Macho', 'Muy cariñoso con la gente en especial con los niños.', '/Images/perros/Pitufo.png'),
(2, 'Elsa', 'Bulldog frances', 1, 1, 'Hembra', 'Todavía es una cachorra y le encanta que le hagan caso. Muy juguetona y activa.', '/Images/perros/Elsa.png'),
(1, 'Adolfo', 'Pastor aleman', 15, 1, 'Macho', 'Es un perro super activo y que le encanta pasear por la rivera o la playa.', '/Images/perros/Adolfo.png'),
(3, 'Kiss', 'Shih Tzu', 11, 1, 'Hembra', 'Le han confundido por un peluche varias veces a lo largo de su vida.', '/Images/perros/Kiss.png'),
(1, 'Javier', 'Bulldog frances', 5, 1, 'Macho', 'Se lleva genial con otros perros y se recomienda para gente que ya tenga uno.', '/Images/perros/Javier.png'),
(1, 'Ronaldo', 'Perro salchicha', 4, 1, 'Macho', 'Apodado Ronaldo por sus ganas constantes de jugar a la pelota.', '/Images/perros/Ronaldo.png'),
(2, 'Pulga', 'Chihuahua', 1, 1, 'Macho', 'No se ya ni que poner aquí me he quedado sin ideas, es un chihuahua y así se queda.', '/Images/perros/Pulga.png'),
(3, 'Pacheco', 'Husky', 2, 1, 'Macho', 'Es algo nervioso y le encanta jugar a la pelota a todas horas.', '/Images/perros/Pacheco.png');
